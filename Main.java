...
class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a) {
        ...
        bob.speed(200);
        bob.width(10);
        bob.penColor("lime");   // สีใบไม้

        // =========================
        // เริ่มจาก "ยอด" ต้นไม้
        // =========================
        bob.up();
        bob.setPosition(0, 160);   // จุดยอด (ปรับได้ตามใจ)
        bob.setDirection(-90);     // หันลงด้านล่าง
        bob.down();

        // เดินลงแบบสลับฟันปลา
        for (int i = 0; i < 5; i++) {
            // ลงเฉียงไปทางขวา
            bob.right(45);          // จากหันลง -> เอียงไปขวา 45°
            bob.forward(i * 20);

            // ลงเฉียงไปทางซ้าย
            bob.left(90);           // 45° ขวา -> กลับไป 45° ซ้าย
            bob.forward(i * 10);

            // กลับมาให้หันลงตรง ๆ อีกครั้ง
            bob.right(45);          // 45° ซ้าย -> ลงตรง
        }

        // ถ้าอยากให้ลงต่อจนถึงลำต้น ตรงนี้จะลงตรงต่ออีกหน่อย
        bob.up();
        bob.setPosition(0, 160);   // จุดยอด (ปรับได้ตามใจ)
        bob.setDirection(-90);     // หันลงด้านล่าง
        bob.down();
        ...
        for (int i = 0; i < 5; i++) {
            // ลงเฉียงไปทางขวา
            bob.left(45);          // จากหันลง -> เอียงไปขวา 45°
            bob.forward(i * 20);

            // ลงเฉียงไปทางซ้าย
            bob.right(90);           // 45° ขวา -> กลับไป 45° ซ้าย
            bob.forward(i * 10);

            // กลับมาให้หันลงตรง ๆ อีกครั้ง
            bob.left(45);          // 45° ซ้าย -> ลงตรง
        }
...
////////////////////////////////////////////////big///////////////////////////////////////////////////
        ...
        Turtle big = new Turtle();

        big.speed(10);
        big.width(10);
        big.penColor("yellow");
        big.up();
        big.setPosition(0, 160);
        big.setDirection(-90);
        big.down();

        for (int j = 0; j < 180; j++) {
            // ลงเฉียงไปทางขวา
            big.left(2);          // จากหันลง -> เอียงไปขวา 45°
            big.forward(1);
            if (j % 45 == 0)
                big.right(180);
        }
        ...
        big.setPosition(0, -150);
        big.setDirection(90);

        ////////////////////////////////////////////bew////////////////////////////////////////////

        Turtle bew = new Turtle();

        bew.speed(1000);
        bew.up();
        bew.penColor("White");
        bew.width(5);
        bew.setPosition(0, -60);
        bew.setDirection(-90);
        bew.penColor("Brown");
        bew.width(20);
        bew.down();
